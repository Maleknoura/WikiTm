...
<body>
        ...
        <div class="container  mt-14">
            <div class="flex justify-center items-center  ">
                <div class="md:w-1/2  ">
                    ...
                    <button class="mt-4 px-6 py-3 text-white bg-blue-300 rounded-full hover:bg-gray-400 focus:outline-none focus:ring focus:border-blue-400">
                        Read More
                    </button>
                </div>
    ...
    <section>
        ...
        ?>
            <h1 class="text-gray-500  text-4xl py-24 mt-12 ml-16">Recent Articles</h1>
            <article class="max-w-2xl px-6  mx-auto space-y-12 dark:bg-gray-800 dark:text-gray-50">
                <div class="w-full mx-auto space-y-4 text-center">
                    <h3><?php echo $wiki['title']; ?></h3>
		...
		<p>Insert a new text content wiki here...</p>
	</div> -->
