...
<div class="flex min-h-screen items-center justify-center bg-white">
    ...
    <?php foreach ($tags as $t) : ?>
      <tr>
        ...
        <td class="p-4 border-b border-blue-gray-50">
        <a href="#" title="Edit" name="edittag" class="editCategorieButton" data-categorie-id="<?php echo $t->getTagID(); ?>" data-categorie-name="<?php echo $t->getTag(); ?>">
    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512">
      ...
      <?php endforeach; ?>
        ...
        <div class="bg-white p-6 rounded-lg">
            ...
            <button onclick="closeEditModal()" type="submit" name="edittag" class="bg-gray-300 text-gray-700 rounded-md p-2.5 ml-2 hover:bg-gray-400">Cancel</button>
        </div>
    </div>
